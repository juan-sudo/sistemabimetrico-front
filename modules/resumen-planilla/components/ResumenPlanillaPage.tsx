...
import { useResumenPlanillaPage } from "../hooks/useResumenPlanillaPage"
import { monthOptions } from "../utils/resumen-planilla.utils"

export default function ResumenPlanillaPage() {
  const {
    token,
    today,
    loading,
                            ...
                            <tr key={item.id} className={index % 2 === 0 ? "bg-white" : "bg-slate-50"}>
                              ...
                              <td className="border-t border-slate-200 px-3 py-2 text-center">
                                <Button
                                  ...
                                  onClick={() => {
                                    handleSelectPersonal(item.id, `${item.numero_documento} - ${item.nombres_completos}`)
                                  }}
                                >
                                  Seleccionar
                                </Button>
